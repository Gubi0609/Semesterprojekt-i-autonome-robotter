...
// Initialize the button on BUTTON_PIN with a pull-up and rising edge interrupt
void init_button() {
    gpio_init(BUTTON_PIN);
    gpio_set_dir(BUTTON_PIN, GPIO_IN);
    gpio_pull_up(BUTTON_PIN);
    // Change the interrupt to detect a rising edge (0 -> 1 transition)
...
// Function to "close the gripper" when the button is released.
// It sets the PWM duty cycle to 500 and waits until the button is released,
